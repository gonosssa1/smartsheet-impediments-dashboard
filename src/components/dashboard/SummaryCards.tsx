...
export default function SummaryCards({ impediments }: SummaryCardsProps) {
  ...
  const cards = [
    { label: "Total Impediments", value: total, accent: "#003399" },
    { label: "Open", value: open, accent: "#0A7CC1" },
    { label: "Closed", value: closed, accent: "#186037" },
    { label: "Escalated", value: escalated, accent: "#DE4702" },
  ];
